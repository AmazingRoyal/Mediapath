    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `article` (`author` TEXT, `title` TEXT, `description` TEXT, `url` TEXT, `source` TEXT, `image` TEXT, `category` TEXT, `language` TEXT, `country` TEXT, `publishedAt` TEXT, PRIMARY KEY (`url`))');
